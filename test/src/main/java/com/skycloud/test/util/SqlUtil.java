 ...
 * SqlUtil.java
 */
package com.skycloud.test.util;
...
public final class SqlUtil {
	...
	public static String toJoinParams(Object... params) {
		...
		sb.append("CRUD Params:").append(NEW_LINE);

		for (Object object : params) {
			sb.append(object).append(NEW_LINE);
		}
	...
	public static String joinAsIn(Object str) {
		...
		String[] arr = String.valueOf(str).split(COMMA);
